<template>
  <v-container>
    <v-row justify="end">
      <v-col cols="12" sm="6">
        <v-text-field v-model="searchTerm" label="Search..." clearable />
      </v-col>
    </v-row>
    <v-data-table v-if="headers" :headers="headers" :items="displayableData" :search="searchTerm" class="elevate-5" :items-per-page="10">
